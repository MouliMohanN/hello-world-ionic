...
object Obfuscation {
  object Frida {
    ...
    // Frida
    val type = intArrayOf(82, 110, 74, 112, 90, 71, 69, 61)
  }
  object SystemCalls {
    ...
    // SystemCalls
    val type = intArrayOf(85, 51, 108, 122, 100, 71, 86, 116, 81, 50, 70, 115, 98, 72, 77, 61)
  }
  object Root {
    // Device is rooted
    ...
    // Root
    val type = intArrayOf(85, 109, 57, 118, 100, 65, 61, 61)
  }
  object DeveloperOptions {
    ...
    // DeveloperOptions
    val type = intArrayOf(82, 71, 86, 50, 90, 87, 120, 118, 99, 71, 86, 121, 84, 51, 66, 48, 97, 87, 57, 117, 99, 119, 61, 61)
  }
  object Emulator {
    // Emulator detected
    ...
    // Emulator
    val type = intArrayOf(82, 87, 49, 49, 98, 71, 70, 48, 98, 51, 73, 61)
  }
  object AppIntegrity {
    // App is not secure
    ...
    // AppIntegrity
    val type = intArrayOf(81, 88, 66, 119, 83, 87, 53, 48, 90, 87, 100, 121, 97, 88, 82, 53)
  }
  object None {
    ...
    // None
    val type = intArrayOf(84, 109, 57, 117, 90, 81, 61, 61)
  }
}
...
//    }
    if (DeveloperOptions.isDetected(context)) {
      return Obfuscation.DeveloperOptions.type.decodeToString()
    }
    if (Root.isDetected(context)) {
      return Obfuscation.Root.type.decodeToString()
    }
    if (Frida.isDetected()) {
      return Obfuscation.Frida.type.decodeToString()
    }
    if (SystemCalls.isDetected()) {
      return Obfuscation.SystemCalls.type.decodeToString()
    }

    if (Emulator.isDetected(context)) {
      return Obfuscation.Emulator.type.decodeToString()
    }
    return Obfuscation.None.type.decodeToString()
  }
  ...
  private fun getTitleAndMessageForSecurityType(type: String): Triple<String, String, Boolean> {
    println(
      "${SECURITY_LOG_TAG.decodeToString()} - getTitleAndMessageForSecurityType \n" +
        "Frida - ${Obfuscation.Frida.type.decodeToString()}, ${Obfuscation.Frida.title.decodeToString()}, ${Obfuscation.Frida.message.decodeToString()}\n" +
        "SystemCalls - ${Obfuscation.SystemCalls.type.decodeToString()}, ${Obfuscation.SystemCalls.title.decodeToString()}, ${Obfuscation.SystemCalls.message.decodeToString()}\n" +
        "Root - ${Obfuscation.Root.type.decodeToString()}, ${Obfuscation.Root.title.decodeToString()}, ${Obfuscation.Root.message.decodeToString()}\n" +
        "DeveloperOptions - ${Obfuscation.DeveloperOptions.type.decodeToString()}, ${Obfuscation.DeveloperOptions.title.decodeToString()}, ${Obfuscation.DeveloperOptions.message.decodeToString()}\n" +
        "Emulator - ${Obfuscation.Emulator.type.decodeToString()}, ${Obfuscation.Emulator.title.decodeToString()}, ${Obfuscation.Emulator.message.decodeToString()}\n" +
        "AppIntegrity - ${Obfuscation.AppIntegrity.type.decodeToString()}, ${Obfuscation.AppIntegrity.title.decodeToString()}, ${Obfuscation.AppIntegrity.message.decodeToString()}\n" +
        "None - ${Obfuscation.None.type.decodeToString()} ${Obfuscation.None.title.decodeToString()}, ${Obfuscation.None.message.decodeToString()}"
    )
    return when (type) {
      Obfuscation.Frida.type.decodeToString() -> Triple(
        Obfuscation.Frida.title.decodeToString(),
        Obfuscation.Frida.message.decodeToString(),
        false
      )

      Obfuscation.SystemCalls.type.decodeToString() -> Triple(
        Obfuscation.SystemCalls.title.decodeToString(),
        Obfuscation.SystemCalls.message.decodeToString(),
        false
      )

      Obfuscation.Root.type.decodeToString() -> Triple(
        Obfuscation.Root.title.decodeToString(),
        Obfuscation.Root.message.decodeToString(),
        false
      )

      Obfuscation.DeveloperOptions.type.decodeToString() -> Triple(
        Obfuscation.DeveloperOptions.title.decodeToString(),
        Obfuscation.DeveloperOptions.message.decodeToString(),
        true
      )

      Obfuscation.Emulator.type.decodeToString() -> Triple(
        Obfuscation.Emulator.title.decodeToString(),
        Obfuscation.Emulator.message.decodeToString(),
        false
      )

      Obfuscation.AppIntegrity.type.decodeToString() -> Triple(
        Obfuscation.AppIntegrity.title.decodeToString(),
        Obfuscation.AppIntegrity.message.decodeToString(),
        false
      )

      Obfuscation.None.type.decodeToString() -> Triple(
  ...
  private fun dispatchResult(callback: (title: String, message: String) -> Unit) {
    result?.let {
      if (it.equals(Obfuscation.None.type.decodeToString())) {
        callback("", "")
        return
      }
  ...
  fun checkAndBlockHacker(
    ...
    securityJob = CoroutineScope(Dispatchers.IO).launch {
      ...
      dispatchResult(callback)
      notifyQueue()
      if (!type.equals(Obfuscation.None.type.decodeToString())) {
